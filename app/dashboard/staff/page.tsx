      ...
      <header className="border-b border-border/50 bg-card/30 backdrop-blur-lg sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div>
            ...
            <h1 className="text-2xl font-bold">Department Dashboard - {currentUser?.department}</h1>
            <p className="text-sm text-muted-foreground">Manage assigned issues and track resolutions</p>
          </div>
